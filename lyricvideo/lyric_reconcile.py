...
def build_reconcile_prompt(lines: list[str], match: AudioMatch, segments: list[dict]) -> str:
    ...
    return (
        ...
        "Leave every line that roughly agrees with the transcript exactly as it is. A line that is merely "
        "absent from the transcript (the recognizer skipped or merged it) is NOT contradicted: do not delete it.\n"
