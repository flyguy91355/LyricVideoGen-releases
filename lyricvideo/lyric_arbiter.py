...
def build_arbiter_prompt(lines: list[str], match: AudioMatch, segments: list[dict]) -> str:
    ...
    return (
        ...
        "- \"lyrics_wrong\": the transcript there clearly holds DIFFERENT coherent lyrics, so the file's lines are "
        "not what is sung (a different verse, edition or song, wrong words, or a section out of order).\n"
